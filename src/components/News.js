...
const News =(props) => {
    ...
    const fetchMoreData = async() => {
        ...
        return (
            <>
                <h1 className="text-center" style={{ marginTop: "90px", marginBottom: "15px" }}> {capitalizeFirstLetter(props.category) === "General" ? "News" : capitalizeFirstLetter(props.category)} - Top Headlines</h1>
                {loading && <Spinner/>}
                <InfiniteScroll
